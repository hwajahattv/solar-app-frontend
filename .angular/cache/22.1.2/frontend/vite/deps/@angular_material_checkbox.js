import { Bi as signal, I as EventEmitter, Mn as forwardRef, U as InjectionToken, et as NgZone, fa as ɵɵnamespaceHTML, ma as ɵɵnamespaceSVG, sa as ɵɵdefineInjector, xr as inject } from "./_resource-chunk-BKjjpPrA.js";
import { Gs as ɵɵviewQuery, Ho as ɵɵprojection, Ji as ɵɵProvidersFeature, Jt as Component, Nn as NgModule, No as ɵɵlistener, O as booleanAttribute, Oi as setClassMetadata, Po as ɵɵloadQuery, Qa as ɵɵdomProperty, S as ViewChild, Sn as Input, Uo as ɵɵprojectionDef, Va as ɵɵdefineNgModule, Wo as ɵɵproperty, Yi as ɵɵadvance, aa as ɵɵclassProp, ao as ɵɵelementStart, eo as ɵɵelement, f as HostAttributeToken, fn as ElementRef, ia as ɵɵclassMap, io as ɵɵelementEnd, is as ɵɵreference, ns as ɵɵqueryRefresh, pr as ViewEncapsulation, qi as ɵɵNgOnChangesFeature, r as ChangeDetectorRef, ra as ɵɵattribute, rt as numberAttribute, za as ɵɵdefineComponent, zn as Output } from "./core-tK2ALGvq.js";
...
var MatCheckbox = class MatCheckbox {
	...
	_onTouchTargetClick() {
		this._handleInputClick();
		if (!this.disabled) this._inputElement.nativeElement.focus();
	}
	_preventBubblingFromLabel(event) {
		if (!!event.target && this._labelElement.nativeElement.contains(event.target)) event.stopPropagation();
	}
