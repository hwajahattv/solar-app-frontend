...
var MIN_HEIGHT = 24;
var MAX_WIDTH = 200;
var MatTooltip = class MatTooltip {
	...
	_defaultOptions = inject(MAT_TOOLTIP_DEFAULT_OPTIONS, { optional: true });
	_overlayRef = null;
	...
	_createOverlay(origin) {
		...
		if (this._defaultOptions?.disableTooltipInteractivity) this._overlayRef.addPanelClass(`${this._cssClassPrefix}-tooltip-panel-non-interactive`);
	...
	_setupPointerExitEventsIfNeeded() {
		...
		if (!this._isTouchPlatform()) {
			this._addListener("mouseleave", (event) => {
				...
				if (!newTarget || !this._overlayRef?.overlayElement.contains(newTarget)) this.hide();
			});
...
var TooltipComponent = class TooltipComponent {
...
//#endregion
export { TOOLTIP_PANEL_CLASS as a, SCROLL_THROTTLE_MS as i, MAT_TOOLTIP_SCROLL_STRATEGY as n, TooltipComponent as o, MatTooltip as r, getMatTooltipInvalidPositionError as s, MAT_TOOLTIP_DEFAULT_OPTIONS as t };
