import { U as InjectionToken, xr as inject } from "./_resource-chunk-BKjjpPrA.js";
import { En as LOCALE_ID } from "./core-tK2ALGvq.js";
import { Qn as Subject } from "./esm5-ChK3bs0s.js";
//#region node_modules/@angular/material/fesm2022/_date-formats-chunk.mjs
...
var DateAdapter = class {
	...
	sameDate(first, second) {
		if (first && second) {
			...
			if (firstValid && secondValid) return !this.compareDate(first, second);
	...
	sameTime(first, second) {
		if (first && second) {
			...
			if (firstValid && secondValid) return !this.compareTime(first, second);
			return firstValid == secondValid;
		}
		return first == second;
	}
...
//#endregion
export { MAT_DATE_FORMATS as n, MAT_DATE_LOCALE as r, DateAdapter as t };
